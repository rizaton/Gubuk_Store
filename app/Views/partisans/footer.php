<footer class="footer footer-center px-10 py-5 bg-primary text-primary-content">
  <aside>
    <svg width="35" height="35" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" class="inline-block fill-current">
    ...
    <p class="font-bold">
      Gubuk Store <br>Membuat Belanja Sembako Lebih Mudah
    </p>
